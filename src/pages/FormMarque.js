          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Formulaire Marque</h4>
                    ...
                    <form className="forms-sample" onSubmit={handleSubmit}>
                      <div className="form-group row">
                        ...
                        <div className="col-sm-9">
                          <input type="text" value={nom} onChange={(e) => setNom(e.target.value)} className="form-control" id="exampleInputUsername2" placeholder="Nom" />
                        </div>
                      </div>
              ...
              <div className="col-lg-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Table Marque</h4>
                    <div className="table-responsive">
                      <table className="table table-hover">
                        ...
                        {marques.map(marque => (
                          <tr>
                            <td>{marque.nom}</td>
                            <td key={marque.id}><label className="badge badge-info">Modifier</label></td>
                            <td key={marque.id}><label className="badge badge-danger">Supprimer</label></td>
                          </tr>
                        ))}
                        </tbody>
                      </table>
