              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Detail de l'annonce</h4>
                    <p className="card-description">Edward</p>
                    <form className="forms-sample">
                      <div className="form-group row">
                        <label for="exampleInputUsername2"><strong>Modele :</strong> BMW Serie 3</label>
                        <div className="col-sm-9"></div>
                        <label for="exampleInputUsername2"><strong>Type de carburant :</strong> Essence</label>
                        <div className="col-sm-9"></div>
                        <label for="exampleInputUsername2"><strong>Kilometrage :</strong> 30 000</label>
                        <div></div>
                        <label for="exampleInputUsername2"><strong>Couleur :</strong> Noir</label>
                        <div className="col-sm-9"></div>
                        <label for="exampleInputUsername2"><strong>Prix :</strong> 50 000 000Ar</label>
                        <div className="col-sm-9"></div>
                        <label for="exampleInputUsername2"><strong>Description</strong></label>
                        <div className="col-sm-9"></div>
                        A vendre : Superbe voiture d'occasion!
                        Ne manquez pas cette occasion de posséder une voiture élégante et performante.
                        Modele BMW Serie 3, année 2018, avec seulement 30 000 kilometres au compteur. 
                        Entretien régulier, état impeccable. Prix négociable.
                        Contactez-nous pour plus d'informations et pour planifier un essai routier!
                      </div>
