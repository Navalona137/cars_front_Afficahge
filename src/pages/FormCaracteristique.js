...
function FormCaracteristique() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/listCaracteristique')
      ...
      .catch(error => {
        console.error('Une erreur s\'est produite lors de la récupération des caracteristiques :', error);
      });
  }, []);
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Formulaire caracteristique</h4>
              ...
              <div className="col-lg-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Table Caracteristiques</h4>
                      ...
                      <table className="table table-hover">
                        ...
                        {caracteristiques.map(caracteristique => (
                          <tr>
                            ...
                            <td key={caracteristique.id}><label className="badge badge-info">Modifier</label></td>
                            <td key={caracteristique.id}><label className="badge badge-danger">Supprimer</label></td>
                          </tr>
                        ))}
                        </tbody>
                      </table>
...
export default FormCaracteristique;
