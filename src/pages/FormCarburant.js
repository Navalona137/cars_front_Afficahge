...
function FormCarburant() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/listCarburant')
      ...
      .catch(error => {
        console.error('Une erreur s\'est produite lors de la récupération des carburants :', error);
      });
  }, []);
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Formulaire Carburant</h4>
              ...
              <div className="col-lg-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">Table Carburant</h4>
                    <div className="table-responsive">
                      <table className="table table-hover">
                        ...
                        {carburants.map(carb => (
                          <tr>
                            <td>{carb.nom}</td>
                            <td key={carb.id}><label className="badge badge-info">Modifier</label></td>
                            <td key={carb.id}><label className="badge badge-danger">Supprimer</label></td>
                          </tr>
                        ))}
                        </tbody>
                      </table>
